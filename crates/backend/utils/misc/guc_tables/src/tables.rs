...
pub static ConfigureNamesBool: &[GucBoolSetting] = &[
    ...
    GucBoolSetting { name: "pgrust.objkv_async_commit", context: PGC_USERSET, group: CUSTOM_OPTIONS, short_desc: Some("Reports an objkv transaction committed before its object reaches the bucket."), long_desc: Some("Like synchronous_commit = off: a crash can lose the most recent commits, but nothing is ever half-applied and conflicts are still refused. Clean shutdown loses nothing."), flags: 0, variable: &vars::pgrust_objkv_async_commit, boot_val: GucDefaultValue::Bool(false), check_hook: None, assign_hook: None, show_hook: None },
...
pub static ConfigureNamesInt: &[GucIntSetting] = &[
    ...
    GucIntSetting { name: "pgrust.objkv_retain_commits", context: PGC_SUSET, group: CUSTOM_OPTIONS, short_desc: Some("How many recent objkv commits stay readable; 0 keeps all history."), long_desc: None, flags: 0, variable: &vars::pgrust_objkv_retain_commits, boot_val: GucDefaultValue::Int(0), min: 0, max: i32::MAX, check_hook: None, assign_hook: None, show_hook: None },
    GucIntSetting { name: "pgrust.objkv_async_queue", context: PGC_SUSET, group: CUSTOM_OPTIONS, short_desc: Some("How many acknowledged objkv commits may wait for the bucket before the next one waits too."), long_desc: Some("Bounds what a crash can lose under pgrust.objkv_async_commit, and what a stuck writer can fence: past this many, an asynchronous COMMIT waits for its object like a synchronous one."), flags: 0, variable: &vars::pgrust_objkv_async_queue, boot_val: GucDefaultValue::Int(64), min: 1, max: 1_000_000, check_hook: None, assign_hook: None, show_hook: None },
    GucIntSetting { name: "pgrust.objkv_snapshot_seq", context: PGC_SUSET, group: CUSTOM_OPTIONS, short_desc: Some("Reads objkv tables as of this commit sequence number (0 = now)."), long_desc: None, flags: 0, variable: &vars::pgrust_objkv_snapshot_seq, boot_val: GucDefaultValue::Int(0), min: 0, max: i32::MAX, check_hook: None, assign_hook: None, show_hook: None },
