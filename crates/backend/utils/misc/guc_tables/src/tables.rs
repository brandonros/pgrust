...
pub static ConfigureNamesBool: &[GucBoolSetting] = &[
    GucBoolSetting { name: "pgrust.s3_create", context: PGC_POSTMASTER, group: REPLICATION_PRIMARY, short_desc: Some("Publishes a clean local database into a new S3 archive."), long_desc: Some("Requires pgrust.s3 and an unused archive prefix. SQL remains closed until initial publication succeeds. Partial creation without a head requires an unused prefix or manual cleanup after all prior creators stop."), flags: GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_s3_create, boot_val: GucDefaultValue::Bool(false), check_hook: None, assign_hook: None, show_hook: None },
    GucBoolSetting { name: "pgrust.s3", context: PGC_POSTMASTER, group: REPLICATION_PRIMARY, short_desc: Some("Restore native state and synchronously publish memory WAL to object storage."), long_desc: Some("Experimental: flat native snapshots are limited to 256 MiB. Publication, renewal or capacity failure stops compute. Recovery requires a fresh data directory and confirmation that prior compute is stopped. Requires S3 GET, PUT, DELETE and ListBucket permissions."), flags: GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_s3, boot_val: GucDefaultValue::Bool(false), check_hook: None, assign_hook: None, show_hook: None },
    ...
    GucBoolSetting { name: "pgrust.strict_synchronous_commit", context: PGC_POSTMASTER, group: REPLICATION_PRIMARY, short_desc: Some("Requires synchronous completion despite cancellation or session termination."), long_desc: Some("Freezes synchronous replication and local durability settings for this server run. Fast shutdown becomes immediate shutdown. Requires fsync, restart_after_crash=off, and either configured synchronous standbys or native S3 publication."), flags: GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_strict_synchronous_commit, boot_val: GucDefaultValue::Bool(false), check_hook: None, assign_hook: None, show_hook: None },
...
pub static ConfigureNamesInt: &[GucIntSetting] = &[
    ...
    GucIntSetting { name: "pgrust.memory_wal", context: PGC_POSTMASTER, group: WAL_CHECKPOINTS, short_desc: Some("Retains native WAL in bounded memory for disposable compute; zero uses disk."), long_desc: Some("Experimental. Requires pgrust.s3, strict completion and at least eight WAL segments of capacity. Capacity exhaustion stops compute. Local PGDATA cannot be restarted; recover from S3."), flags: GUC_UNIT_MB | GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_memory_wal_mb, boot_val: GucDefaultValue::Int(0), min: 0, max: 1024, check_hook: None, assign_hook: None, show_hook: None },
    GucIntSetting { name: "pgrust.strict_wal_budget", context: PGC_POSTMASTER, group: WAL_CHECKPOINTS, short_desc: Some("Stops strict-mode compute before exceeding its unconfirmed WAL generation budget."), long_desc: Some("Measured from synchronous flush confirmation or this server run's starting WAL position, whichever is later. Exceeding the budget causes PANIC; this is not a bound on total disk usage."), flags: GUC_UNIT_MB | GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_strict_wal_budget_mb, boot_val: GucDefaultValue::Int(1024), min: 1, max: MAX_KILOBYTES, check_hook: None, assign_hook: None, show_hook: None },
...
pub static ConfigureNamesString: &[GucStringSetting] = &[
    GucStringSetting { name: "pgrust.s3_endpoint", context: PGC_POSTMASTER, group: REPLICATION_PRIMARY, short_desc: Some("Object storage endpoint; nonlocal endpoints require HTTPS."), long_desc: None, flags: GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_s3_endpoint, boot_val: GucDefaultValue::String(None), check_hook: None, assign_hook: None, show_hook: None },
    GucStringSetting { name: "pgrust.s3_bucket", context: PGC_POSTMASTER, group: REPLICATION_PRIMARY, short_desc: Some("Existing bucket containing native backups and WAL."), long_desc: None, flags: GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_s3_bucket, boot_val: GucDefaultValue::String(None), check_hook: None, assign_hook: None, show_hook: None },
    GucStringSetting { name: "pgrust.s3_prefix", context: PGC_POSTMASTER, group: REPLICATION_PRIMARY, short_desc: Some("Object key prefix identifying this database."), long_desc: None, flags: GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_s3_prefix, boot_val: GucDefaultValue::String(None), check_hook: None, assign_hook: None, show_hook: None },
    GucStringSetting { name: "pgrust.s3_region", context: PGC_POSTMASTER, group: REPLICATION_PRIMARY, short_desc: Some("Object storage signing region."), long_desc: None, flags: GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_s3_region, boot_val: GucDefaultValue::String(None), check_hook: None, assign_hook: None, show_hook: None },
    GucStringSetting { name: "pgrust.s3_fenced_head", context: PGC_POSTMASTER, group: REPLICATION_PRIMARY, short_desc: Some("SHA256 of the head observed after independently stopping previous compute; not a death detector."), long_desc: None, flags: GUC_NOT_IN_SAMPLE | GUC_NO_SHOW_ALL, variable: &vars::pgrust_s3_fenced_head, boot_val: GucDefaultValue::String(None), check_hook: None, assign_hook: None, show_hook: None },
